...
export default function SpinWheelScreen({ user, onUserUpdate }: SpinWheelScreenProps) {
  ...
  const spinWheel = () => {
    ...
    // Calculate a random degree within the target segment
    ...
    }, 4000) // Match this to the CSS transition duration
  }
            ...
            {segments.map((s, i) => (
              <div
                ...
                style={{
                  ...
                  clipPath: `polygon(50% 0%, 100% 0%, 100% 100%, 50% 100%)`, // This is a simplified clip-path, actual pie slices are complex
                  // For visual segments, you'd typically use SVG or more complex CSS
                }}
              >
